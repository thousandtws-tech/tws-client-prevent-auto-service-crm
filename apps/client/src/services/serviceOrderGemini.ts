...
const buildFallbackText = (
  ...
  return [
    ...
    `Composição do faturamento aprovado: peças ${formatCurrency(summary.totalPartsApprovedValue)}, serviços ${formatCurrency(summary.totalLaborApprovedValue)} e terceiros ${formatCurrency(summary.totalThirdPartyApprovedValue)}.`,
